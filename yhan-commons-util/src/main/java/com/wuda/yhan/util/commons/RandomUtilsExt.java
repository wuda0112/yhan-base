...
public class RandomUtilsExt {
     ...
     *
     * @param length
     *         字符串长度,如果小于1,则返回空字符串(不是<code>null</code>).
     * @return 字符串
     */
     ...
     * @param length
     *         长度
     * @param codePointStartInclusive
     *         unicode code point范围的起始值,包含
     * @param codePointEndExclusive
     *         unicode code point范围的结束值,不包含
     * @return 随机字符串
     */
     ...
     *
     * @param codePointStartInclusive
     *         unicode code point 结束值,不包含
     * @param codePointEndExclusive
     *         unicode code point 起始值,包含
     * @return char
     */
