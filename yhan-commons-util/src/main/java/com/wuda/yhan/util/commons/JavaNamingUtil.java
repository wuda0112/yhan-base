...
public class JavaNamingUtil {
    ...
    public static String genGetterMethodName(String fieldName) {
        String methodName = StringUtil.firstCharToUpperCase(fieldName);
        return StringUtil.addPrefix(methodName, prefix_get);
    }
    ...
    public static String genSetterMethodName(String fieldName) {
        String methodName = StringUtil.firstCharToUpperCase(fieldName);
        return StringUtil.addPrefix(methodName, prefix_set);
    }
}
